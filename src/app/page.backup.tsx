...
import { Plus, Package, FileText, TrendingUp, AlertTriangle } from "lucide-react"
          ...
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Sistema empresarial de gestión</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              {stats.total > 0 && (
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="shadow-lg border-0 hover:shadow-xl transition-shadow">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">Productos registrados en el sistema</p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-lg border-0 hover:shadow-xl transition-shadow">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">Productos en stock disponible</p>
            </CardContent>
          </Card>

          <Card className="shadow-lg border-0 hover:shadow-xl transition-shadow sm:col-span-2 lg:col-span-1">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-3">
              <div>
                <CardTitle className="text-sm font-semibold text-muted-foreground uppercase tracking-wide">
                  Agotados
        ...
        <Card className="shadow-lg border-0">
          ...
          <CardContent>
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-2xl mx-auto">
              ...
              <Button variant="outline" className="gap-2 h-12 px-8 text-base font-semibold bg-transparent">
